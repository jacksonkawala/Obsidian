...
A catalog of all pages in the knowledge base, organized by domain.
...
- [Nataka TSF](wiki/tsf/nataka-tsf.md) — Entity page for the Nataka Tailings Storage Facility at Kenmare Moma Mine, Mozambique. Phase 1 capacity 741,000t, Lift 1 raise in progress.
- [Lift 1 Construction Log](wiki/tsf/lift1-construction-log.md) — Compiled from WhatsApp group (Dec 2025 – Apr 2026). 750mm sand layers from 22 RL to 33 RL. Key issues: roller breakdowns, operator shortages, rain disruptions, space constraints.
- [TSF Operations Log](wiki/tsf/tsf-operations-log.md) — Compiled from WhatsApp group (Oct 2025 – Apr 2026). Pump status, water levels, slimes extraction. By Apr 2026: all pumps down, TSF WL 24.6 mRL (above max 24.0), water return capacity at zero.
...
- [Freeboard](wiki/concepts/freeboard.md) — Vertical distance between pool surface and dam crest. Critical TSF safety parameter with TARP-level monitoring. Links to CSSM through pore pressure and effective stress.
